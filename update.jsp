...
<body>
    ...
    <div id=container>
        <div id=login_div>
            <form action="updateAction.jsp" onsubmit="handleSubmit(event)">
                ...
                <br>
                <input type="text" name="name_value" class=input_button placeholder="이름(1글자이상)">
                <br>
                ...
                <br>
                <br>
                <input type="submit" value="개인정보 수정완료" class=input_button>
        </div>
    </div>
    <script>
