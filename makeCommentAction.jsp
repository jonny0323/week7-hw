...
<%
    ...
    String boardidValue=request.getParameter("boardid_value");
    ...
    //치고자 싶은 명령어!!
    String sql="INSERT INTO comment (id, board_idx ,comment) VALUES (?,?,?);";
    PreparedStatement query = connect.prepareStatement(sql);
    query.setString(1,sessionId);
    query.setString(2,boardidxValue);
