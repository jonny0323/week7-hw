...
<%
    ...
    String commentidxValue=request.getParameter("commentidx_value");
...
<div id=container>
    ...
    <div id=container>
        ...
        <div id=login_div>
            <form action="updateCommentAction.jsp">
                <input type="hidden" name="commentidx_value" value="<%=commentidxValue%>">
                <textarea rows="4" cols="50" name="comment_value" class=input_button id=content   placeholder="CONTENT">
                </textarea>
                <br>
                <br>
                <input type="submit" value="댓글 수정 완료" class=input_button>
            </form>
            <form action="deleteCommentAction.jsp">
                <input type="hidden" name="commentidx_value" value="<%=commentidxValue%>">
                <input type="submit" value="댓글 삭제하기" class=input_button>
            </form>
        </div>
    </div>
    <script>
